...
mod tests {
    ...
    fn test_from_env_with_defaults() {
        ...
        assert_eq!(
            config.database_url,
            "mysql://test-user:test-pass@test-host:3307/test-db"
        );
    ...
    fn test_from_env_invalid_max_connections() {
        ...
        assert!(result
            .unwrap_err()
            .to_string()
            .contains("DB_MAX_CONNECTIONS must be a valid number"));
